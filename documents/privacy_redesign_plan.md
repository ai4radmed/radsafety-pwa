...
| C    | Vercel 과거 배포 URL 차단: Deployment Protection 켜기 또는 2026-02-04 이후 배포 삭제 (대시보드, Dr. Ben)                                                                         | **완료 2026-09-08** — Vercel Authentication · Standard Protection 적용. 확인: `*.vercel.app` 배포 주소는 Vercel SSO 로 302, `radsafety.kr` 은 200 유지                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
