...
```
radsafety.kr 모든 점검항목 정상 (28/28)
2026-07-14 06:31 KST · v0.2.1 · 전체 점검

1. 보안 접속·주소 연결
1-1. https://radsafety.kr → 200 OK [o]
1-2. HSTS 헤더 존재 [o]
1-3. www → https://radsafety.kr/ [o]
...
...
8. 실제 브라우저 화면
8-28. 홈·로그인 화면 렌더링(JS 오류 감지) [o]
```

**이상일 때** — 머리줄이 건수를 말하고, 맨 아래 한 줄이 문제 번호를 가리킵니다:

```
radsafety.kr 점검항목 문제 2건 · 경고 1건 (25/28 정상)
2026-07-14 06:31 KST · v0.2.1 · 전체 점검
...
7-24. [3] db-ping — unreachable [x]

8. 실제 브라우저 화면
8-28. 홈·로그인 화면 렌더링(JS 오류 감지) — Playwright 실패, 실행 로그 참조 [x]
