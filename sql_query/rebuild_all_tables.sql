...
-- ============================================================
-- 15. 2-1 업로드 권한 (2026-09-19) — sql_query/migrate_add_publish_gate.sql 과 동일 내용
-- ============================================================
-- can_publish/reject_count, archives·findings status(+file_bucket), 트리거, RLS 교체, 비공개 버킷.
-- 기존 환경은 migrate 파일로, 신규 설치는 이 섹션으로. 둘 다 멱등.
